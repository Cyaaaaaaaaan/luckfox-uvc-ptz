...
echo "  # NOTE: /oem is read-only and rk_mpi_uvc may be running."
echo "  # Stage everything through /tmp first, then kill+remount+move in one SSH call."
echo ""
RETINA_MODEL="$HOME/luckfox_pico_rkmpi_example/example/luckfox_pico_rtsp_retinaface/model/retinaface.rknn"
